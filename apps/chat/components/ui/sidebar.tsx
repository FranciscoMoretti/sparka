...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed top-(--electron-titlebar-height,0px) bottom-0 z-10 hidden h-[calc(100svh-var(--electron-titlebar-height,0px))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
