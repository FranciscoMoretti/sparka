...
2. Writes the tool's files into your project (under the path configured in `chat.config.ts`)
3. Installs any npm dependencies the tool declares
4. Injects imports and registrations into `tools/index.ts`
