...
The CLI walks you through selecting your AI gateway, features, and auth providers, then generates a configured project with `chat.config.ts` ready to go. It also asks whether to include an [Electron desktop app](/desktop/electron). It automatically detects your package manager and creates the appropriate lock file.
...
<CardGroup cols={2}>
  ...
  <Card title="Desktop App" icon="desktop" href="/desktop/electron">
